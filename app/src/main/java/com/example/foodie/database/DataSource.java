...
public class DataSource {
    ...
    public long getDataItemsCount(){
        //DatabaseUtils is an Android helper class
        //this method returns the number of entries in the table TABLE_ITEMS
    ...
    public List<DataItem> getAllItems(){
        ...
        Cursor cursor = mDatabase.query(ItemsTable.TABLE_ITEMS, ItemsTable.ALL_COLUMN,
